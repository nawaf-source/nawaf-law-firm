    ...
    <div className="page">
      ...
      <section style={{
        ...
        <div style={{
          ...
          {/* Large pattern panel — left half of hero, like the cover */}
          <div style={{
            position: "absolute",
            top: 0,
            bottom: 0,
            left: 0,
            width: "55%",
            backgroundImage: "url(assets/logo-pattern-tile.jpg)",
            backgroundRepeat: "repeat",
            backgroundSize: "auto 380px",
            opacity: 0.32,
            animation: "patternDrift 50s linear infinite",
            // Soft right-edge feathering into navy
            maskImage: "linear-gradient(90deg, rgba(0,0,0,0.85) 0%, rgba(0,0,0,0.65) 35%, rgba(0,0,0,0.35) 65%, transparent 100%)",
            WebkitMaskImage: "linear-gradient(90deg, rgba(0,0,0,0.85) 0%, rgba(0,0,0,0.65) 35%, rgba(0,0,0,0.35) 65%, transparent 100%)"
          }} />

          {/* Strong navy wash on the pattern to keep it from competing with text */}
          <div style={{
            position: "absolute",
          ...
          {/* light sweep gliding across the hero pattern */}
          <div style={{
            position: "absolute",
            top: 0, bottom: 0, left: 0,
            width: "55%",
            background: "linear-gradient(115deg, transparent 30%, rgba(232,204,146,0.18) 45%, rgba(255,247,224,0.5) 50%, rgba(232,204,146,0.18) 55%, transparent 70%)",
            mixBlendMode: "screen",
            animation: "heroLightSweep 6s ease-in-out infinite",
            maskImage: "linear-gradient(90deg, rgba(0,0,0,0.9) 0%, rgba(0,0,0,0.5) 60%, transparent 100%)",
            WebkitMaskImage: "linear-gradient(90deg, rgba(0,0,0,0.9) 0%, rgba(0,0,0,0.5) 60%, transparent 100%)",
            pointerEvents: "none"
          }} />
          ...
          <div style={{
            ...
            <div className="fade-in">
              ...
              <h1 className="display" style={{
                ...
                lineHeight: 1.05,
                marginBottom: 28, fontFamily: "Tajawal", width: "852px"
              }}>
                <span className="silver-grad" style={{ fontFamily: "Cairo" }}>نحمل عنك</span>
                <br />
                <span style={{ color: "var(--ivory-100)", fontFamily: "Cairo" }}>عبء القضية</span>
                <span style={{ color: "var(--gold-200)", fontFamily: "var(--f-serif)" }}>…</span>
                <br />
                <span className="serif" style={{ fontStyle: "italic", color: "var(--gold-200)", fontWeight: 400, fontSize: "80px", textShadow: "0 2px 24px rgba(241,221,176,0.35)", fontFamily: "Tajawal", lineHeight: "1.35" }}>ونسير معك في كل خطوة
            ...
            <div className="fade-in fade-in-delay-2" style={{
              ...
              <div style={{ marginBottom: 36 }}>
                ...
                <p className="serif" style={{
                  ...
                  color: "var(--ivory-100)",
                  marginTop: 12,
                  fontStyle: "italic", fontFamily: "Tajawal"
                }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 80, alignItems: "start" }} className="about-grid">
            <Reveal>
              ...
              <h2 className="display" style={{ color: "var(--navy-800)", fontFamily: "Cairo", fontSize: "64px", textAlign: "right", fontWeight: "500", width: "587px", padding: "0px", margin: "-2px", borderWidth: "0px", borderStyle: "solid", borderRadius: "0px", height: "285px", letterSpacing: "0.3px", lineHeight: "1.8" }}>
                التخصّص القانوني<br />
                <span className="serif" style={{ fontStyle: "italic", color: "var(--gold-600)", fontFamily: "Tajawal", fontWeight: "500" }}>أساسٌ</span>{" "}
                لقرارات سليمة.
              </h2>
            </Reveal>
      ...
      <section className="section" style={{ background: "var(--ivory-50)" }}>
        <div className="container">
          ...
          <div style={{
            ...
            <ServiceCellRow key={s.id} s={s} setRoute={setRoute} />
            )}
          </div>
          ...
          <div style={{ marginTop: 56, textAlign: "center" }}>
            <a href="#" className="btn btn-ghost-navy" onClick={(e) => {e.preventDefault();setRoute("services");window.scrollTo(0, 0);}}>
              <span>عرض كل المجالات (٩ مجالات)</span><span className="arrow"></span>
            </a>
          </div>
        </div>
      </section>
      ...
      <section className="section" style={{
        ...
        <div className="container" style={{ position: "relative", zIndex: 1 }}>
          <SectionHead num="03" eyebrow="لماذا تختارنا" title={<span style={{ color: "var(--ivory-100)" }}>أربعة أعمدة <span className="serif" style={{ fontStyle: "italic", color: "var(--gold-400)", lineHeight: "1.2", textAlign: "left", fontFamily: "Tajawal", letterSpacing: "2.4px", padding: "8px", fontSize: "116px" }}>للثقة</span></span>} en="Why Us" />
          ...
          <div style={{
            ...
            <Reveal key={w.num} delay={i * 80}>
                ...
                minHeight: 260
                  ...
                  <div className="serif" style={{ fontSize: 56, color: "var(--gold-200)", fontStyle: "italic", lineHeight: 1, marginBottom: 24, textShadow: "0 2px 18px rgba(241,221,176,0.25)" }}>
                    {w.num}
                  </div>
      ...
      <section className="section" style={{ background: "var(--ivory-100)" }}>
        <div className="container">
          ...
          <div style={{
            ...
            <div style={{
              position: "absolute", top: 30, right: 40, left: 40,
      ...
      <section style={{
        ...
        <div style={{
          ...
          opacity: 0.06,
          animation: "scalesSway 9s ease-in-out infinite"
        }}>
        ...
        <style>{`
          ...
          @media (prefers-reduced-motion: reduce) {
            [style*="scalesSway"] { animation: none !important; }
          }
        `}</style>
        ...
        <div className="container" style={{ position: "relative", zIndex: 1, fontFamily: "Tajawal" }}>
          <div style={{ maxWidth: 720 }}>
            ...
            <h2 className="display" style={{ fontSize: "clamp(36px, 5.5vw, 64px)", lineHeight: 1.1, fontFamily: "Cairo", height: "135px", width: "740px" }}>
              ...
              <br />
              <span className="serif" style={{ fontStyle: "italic", color: "var(--gold-200)", fontWeight: 400, padding: "0px 20px 0px 0px", textShadow: "0 2px 24px rgba(241,221,176,0.3)", fontFamily: "Cairo", letterSpacing: "0px" }}>
                يبقى داخل جدرانه.
              </span>
            </h2>
...
function ServiceCellRow({ s, setRoute }) {
  return (
    <div
  ...
  return (
    <div className="page">
      <PageHero
        num="01"
        eyebrow="من نحن"
        title={<span><span style={{ color: "var(--ivory-100)" }}>مكتبٌ يؤمن بأن</span><br /><span className="serif" style={{ fontStyle: "italic", color: "var(--gold-300)", fontFamily: "Tajawal" }}>التخصّص</span> طريق العدالة.</span>}
        en="About the Firm"
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1.2fr", gap: 80, alignItems: "center" }} className="founder-grid">
            <Reveal>
              <div style={{
                ...
                {/* light sweep gliding across the pattern */}
                <div style={{
                  position: "absolute",
                  inset: 0,
                ...
                <style>{`
                  ...
                  @media (prefers-reduced-motion: reduce) {
                    ...
                    [style*="glowPulse"], [style*="orbitSpin"], [style*="sparkTwinkle"], [style*="sheenSweep"],
  ...
  return (
    <div className="page">
      <PageHero
        ...
        title={<span><span style={{ color: "var(--ivory-100)" }}>تسعة مجالات</span><br /><span className="serif" style={{ fontStyle: "italic", color: "var(--gold-300)", fontFamily: "Tajawal", letterSpacing: "2.3px", lineHeight: "1.15" }}>لممارسة قانونية</span> متخصصة.</span>}
        en=" Nine Areas of Practice   "
      ...
      <section className="section" style={{ background: "var(--ivory-100)" }}>
        <div className="container">
          <div style={{
            ...
            {SERVICES.map((s) => <ServiceCellRow key={s.id} s={s} setRoute={setRoute} />)}
          </div>
          <style>{`
  ...
  return (
    <div className="page">
      <PageHero
        num="06"
        eyebrow="تواصل معنا"
        title={<span>نسمعك<br /><span className="serif" style={{ fontStyle: "italic", color: "var(--gold-300)", fontFamily: "Tajawal" }}>قبل أن نتحدث.</span></span>}
        en="Get in Touch"
              ...
              <div style={{
                ...
                <form onSubmit={submit} style={{ display: "grid", gap: 20 }}>
                    ...
                    <button type="submit" className="btn btn-gold" style={{ justifySelf: "start" }}>
                      <span>إرسال الرسالة</span><span className="arrow"></span>
                    </button>
