  ...
  return (
    <>
      <PageHero
        ...
        title={<><span style={{ color: "var(--ivory-100)" }}>اثنا عشر مجالًا</span><br/><span className="serif" style={{ fontStyle: "italic", color: "var(--gold-300)" }}>لممارسة قانونية</span> متخصصة.</>}
        en="Twelve Areas of Practice"
