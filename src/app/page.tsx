...
export default function HomePage() {
  return (
    <>
        ...
        <div className="container">
          ...
          <div style={{ marginTop: 56, textAlign: "center" }}>
            <Link href="/services" className="btn btn-ghost-navy">
              <span>عرض كل المجالات (١٢ مجالًا)</span><span className="arrow"></span>
            </Link>
          </div>
        </div>
      </section>
      ...
      <section className="section" style={{ background: "var(--ivory-100)" }}>
        <div className="container">
          <SectionHead num="04" eyebrow="خطوات العمل" title="من الطلب إلى الحكم" en="Our Process" />
          <div className="proc-grid" style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 0, position: "relative" }}>
