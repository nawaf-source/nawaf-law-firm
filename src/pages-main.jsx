...
import { SERVICES, WHY_US, PROCESS, CONTACT, SA_REGIONS } from "./data.js";
import { SectionHead, Reveal, CtaStrip, PageHero, DecorPattern, ScalesGlyph, TitleAccent, Field, PillRadio, Checkbox, validators, BrandLogo } from "./components.jsx";
/* ============================================
    ...
    <div className="page">
      ...
      <section className="section" style={{
        ...
        <div className="container" style={{ position: "relative", zIndex: 1 }}>
          <SectionHead num="03" eyebrow="لماذا تختارنا" title={<span style={{ color: "var(--ivory-100)" }}>أربعة أعمدة <span className="serif" style={{ color: "var(--gold-400)", lineHeight: "1.2", textAlign: "left", fontFamily: "Tajawal", fontWeight: "400", fontSize: "100px", letterSpacing: "0px", padding: "0px", margin: "-19px" }}> للثقة</span></span>} en="Why Us" />
      ...
      <section style={{
        ...
        <div
          ...
          <div className="emblem-stage" style={{
            ...
            {/* rotating conic halo (sits behind, in 3D depth) */}
            <div style={{
              position: "absolute", top: "50%", left: "50%",
              width: "92%", aspectRatio: "1", transform: "translate(-50%, -50%) translateZ(-60px)",
              background: "conic-gradient(from 0deg, transparent 0deg, rgba(217,184,114,0.16) 60deg, transparent 120deg, rgba(208,210,215,0.14) 200deg, transparent 280deg, rgba(217,184,114,0.12) 340deg, transparent 360deg)",
              borderRadius: "50%", filter: "blur(26px)",
              animation: "haloSpin 20s linear infinite"
            }} />
            {/* pulsing glow hugging the mark */}
            <div style={{
              position: "absolute", top: "50%", left: "50%",
              width: "68%", aspectRatio: "1", transform: "translate(-50%, -50%) translateZ(-20px)",
              background: "radial-gradient(circle, rgba(232,204,146,0.2) 0%, transparent 65%)",
              borderRadius: "50%", animation: "glowPulse 5.5s ease-in-out infinite"
            }} />
            {/* rotating light-line arc tracing a ring around the mark */}
            <div style={{
              position: "absolute", top: "50%", left: "50%",
              ...
              borderRadius: "50%",
              padding: "2px",
              background: "conic-gradient(from 0deg, transparent 0deg, transparent 280deg, rgba(232,204,146,0.0) 300deg, rgba(255,243,205,0.9) 350deg, rgba(232,204,146,0.6) 358deg, transparent 360deg)",
              WebkitMask: "radial-gradient(farthest-side, transparent calc(100% - 2.5px), #000 calc(100% - 2px))",
              mask: "radial-gradient(farthest-side, transparent calc(100% - 2.5px), #000 calc(100% - 2px))",
              animation: "ringTrace 6s linear infinite",
              zIndex: 1, opacity: "1"
            }} />
            {/* the mark itself — idle float */}
            <div style={{
              position: "absolute", inset: 0,
              display: "flex",
              ...
              <img src="/assets/logo-mark-transparent.png" alt="" aria-hidden="true" className="emblem-img" style={{
                ...
                filter: "drop-shadow(0 18px 30px rgba(0,0,0,0.55))", opacity: "1", objectFit: "cover"
              }} />
            </div>
            {/* small orbiting dots */}
            <div style={{
              ...
              transformStyle: "preserve-3d",
              animation: "orbitSpin 16s linear infinite", zIndex: 3
            }}>
              ...
              <span key={i} style={{
                ...
                boxShadow: "0 0 12px rgba(232,204,146,0.8)",
                transform: `rotate(${deg}deg) translateX(${110 + i % 3 * 22}px) translateZ(${i % 2 ? 70 : -70}px)`,
        ...
        <style>{`
          @keyframes ringTrace { from { transform: translate(-50%,-50%) rotate(0deg);} to { transform: translate(-50%,-50%) rotate(360deg);} }
          @keyframes haloSpin { from { transform: translate(-50%,-50%) rotate(0deg);} to { transform: translate(-50%,-50%) rotate(360deg);} }
          @keyframes glowPulse { 0%,100% { opacity:0.5; transform: translate(-50%,-50%) scale(0.9);} 50% { opacity:1; transform: translate(-50%,-50%) scale(1.12);} }
          @keyframes orbitSpin { from { transform: translate(-50%,-50%) rotate(0deg);} to { transform: translate(-50%,-50%) rotate(360deg);} }
          @keyframes sparkTwinkle { 0%,100% { opacity:0.35;} 50% { opacity:1;} }
  ...
  return (
    <div className="page">
      <PageHero
        ...
        title={<span><span style={{ color: "var(--ivory-100)" }}>تسعة مجالات</span><br /><span className="serif" style={{ color: "var(--gold-300)", fontFamily: "Tajawal", letterSpacing: "2.3px", lineHeight: "1.15" }}>لممارسة قانونية</span> متخصصة.</span>}
