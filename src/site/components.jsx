...
import { ParallaxLayer } from "./motion.jsx";
/* ============================================
  ...
  return (
    <>
      <header className={`header ${scrolled || route !== "home" ? "scrolled" : ""}`}>
        <div className="container header-inner" style={{ borderStyle: "solid", margin: "0px 174px", gap: "87px", lineHeight: "1.1", padding: "0px 32px 17px", borderWidth: "0px", borderRadius: "0px", justifyContent: "center", alignItems: "center", flexDirection: "row", letterSpacing: "0px", textAlign: "center", width: "1306px", height: "132px" }}>
          <a href="#" className="brand" onClick={go("home")}>
            <img
              ...
              style={{ display: "block", padding: "0px", height: "106px", width: "auto", objectFit: "contain", margin: "6px" }} />
          ...
          <nav className="nav">
            ...
            <a
              ...
              href="#"
              onClick={go(item.id)}
              className={route === item.id ? "active" : ""} style={{ fontSize: "17px" }}>
  ...
  return (
    <img
      ...
      style={{ ...{
          ...
          ...style, margin: "0px"
        }, objectFit: "cover", padding: "0px", borderRadius: "0px", borderWidth: "0px", borderStyle: "solid", height: "55px", width: "79px", opacity: "1", margin: "-56px -14px -11px -26px" }} />);
  ...
  return (
    <div className="section-head">
      <div style={{ display: "flex", gap: 14, justifyContent: "flex-start", alignItems: "flex-start" }}>
        ...
        <span className="eyebrow" style={{ fontSize: "25px", padding: "0px", margin: "-3px", borderRadius: "0px", width: "205px", letterSpacing: "17px", height: "85px" }}>{eyebrow}</span>
      </div>
...
function PageHero({ num, eyebrow, title, lead, en }) {
  return (
    <section className="page-hero" style={{
      ...
      <ParallaxLayer className="pattern-band top" speed={0.14} style={{ height: 110, opacity: 0.15 }} />
      <ParallaxLayer className="pattern-band side-left" speed={0.26} style={{ width: "55%", opacity: 0.5, WebkitMaskImage: "linear-gradient(90deg, rgba(0,0,0,1) 0%, rgba(0,0,0,0.6) 60%, transparent 100%)", maskImage: "linear-gradient(90deg, rgba(0,0,0,1) 0%, rgba(0,0,0,0.6) 60%, transparent 100%)" }} />
      <div className="navy-light-sweep"></div>
      <DecorPattern />
...
export function WhatsAppFab() {
  const href = "https://wa.me/966591119098?text=" + encodeURIComponent("السلام عليكم، أرغب بالتواصل مع مكتب المحامي نواف بن أحمد المالكي.");
  return (
    <a
      href={href}
      target="_blank"
      ...
      <svg viewBox="0 0 32 32" width="28" height="28" aria-hidden="true">
        <path fill="currentColor" d="M16 3C9.4 3 4 8.4 4 15c0 2.1.6 4.2 1.6 6L4 29l8.2-1.6c1.8.9 3.8 1.4 5.8 1.4 6.6 0 12-5.4 12-12S22.6 3 16 3zm0 21.8c-1.8 0-3.5-.5-5-1.3l-.4-.2-4.9 1 1-4.8-.2-.4c-.9-1.6-1.4-3.3-1.4-5.1C5.1 9.5 9.9 4.8 16 4.8c5.6 0 10.2 4.6 10.2 10.2S21.6 24.8 16 24.8zm5.6-7.6c-.3-.2-1.8-.9-2.1-1-.3-.1-.5-.2-.7.2-.2.3-.8 1-1 1.2-.2.2-.4.2-.7.1-.3-.2-1.3-.5-2.5-1.5-.9-.8-1.5-1.8-1.7-2.1-.2-.3 0-.5.1-.7.1-.1.3-.4.5-.6.1-.2.2-.3.3-.5.1-.2 0-.4 0-.6 0-.2-.7-1.7-1-2.3-.3-.6-.5-.5-.7-.5h-.6c-.2 0-.5.1-.8.4-.3.3-1 1-1 2.5s1.1 2.9 1.2 3.1c.2.2 2.1 3.2 5.1 4.5.7.3 1.3.5 1.7.6.7.2 1.4.2 1.9.1.6-.1 1.8-.7 2-1.4.3-.7.3-1.3.2-1.4-.1-.2-.3-.2-.6-.4z"></path>
      </svg>
    </a>);
