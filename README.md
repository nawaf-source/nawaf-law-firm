...
> **الخدمات المضمّنة:** ١٢ مجال ممارسة، نموذج تسجيل قضية بأربع خطوات، طلب استشارة، تواصل، أسئلة شائعة، خصوصية، شروط
...
|---|---|---|
| `RESEND_API_KEY` | من resend.com بعد التسجيل | ✅ نعم |
| `RESEND_FROM` | `مكتب المالكي <noreply@law-2030.com>` | ✅ نعم |
| `CONTACT_EMAIL` | `nawaf@law-2030.com` | ✅ نعم |
...
| قائمة الخدمات الـ ١٢ | `src/lib/data.ts` (مصفوفة `SERVICES`) |
